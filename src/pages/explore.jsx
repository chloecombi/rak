                    ...
                    <div className='flex flex-col items-center mb-12'>
                        <div className='mb-16 text-white text-center'>
                            <h1 className='text-5xl  font-bold font-body mb-2'>
                                🦝 Racccoon NFT Portfolio 🦝
                            </h1>
                            <p> Check ETH Portfolios using wallet address / collection address </p>
                        </div>
                        ...
                        <button className='py-3 bg-gold rounded-sm w-full hover:bg-gold-300 text-black' onClick={() => {fetchNFTs(owner, contractAddress, setNFTs    )}}>Search</button>
                        </div>
                    </div>
                </header>
